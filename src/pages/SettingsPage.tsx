    ...
    <div className="page-container">
      <div className="settings-content">
        <div className="setting-row">
          ...
          <div className="setting-value">
            <div className="setting-number">
              <button onClick={() => handleSettingChange('studyTime', Math.max(1, localSettings.studyTime - 1))}>−</button>
              <span>{localSettings.studyTime}</span>
              <button onClick={() => handleSettingChange('studyTime', Math.min(60, localSettings.studyTime + 1))}>+</button>
            </div>
            分钟
          </div>
        </div>
        ...
        <div className="setting-row">
          ...
          <div className="setting-value">
            <div className="setting-number">
              <button onClick={() => handleSettingChange('shortTime', Math.max(1, localSettings.shortTime - 1))}>−</button>
              <span>{localSettings.shortTime}</span>
              <button onClick={() => handleSettingChange('shortTime', Math.min(30, localSettings.shortTime + 1))}>+</button>
            </div>
            分钟
          </div>
        </div>
        ...
        <div className="setting-row">
          ...
          <div className="setting-value">
            <div className="setting-number">
              <button onClick={() => handleSettingChange('longTime', Math.max(1, localSettings.longTime - 1))}>−</button>
              <span>{localSettings.longTime}</span>
              <button onClick={() => handleSettingChange('longTime', Math.min(60, localSettings.longTime + 1))}>+</button>
            </div>
            分钟
          </div>
        </div>
